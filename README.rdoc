...
There is the example of the application which can help to manage settings.
...
These scenarios can help you to verify the application. You can pass it on the demo site: http://configuration.heroku.com
